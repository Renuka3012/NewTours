...
public class Moster_Dropdown {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		WebElement currentLocation=driver.findElement(By.xpath("//*[@ type='text']"));
		
		List<WebElement> currentLocationlements=currentLocation.findElements(By.tagName("option"));
		
		int currenLocationElements_Count = currentLocationlements.size();
		System.out.println(currenLocationElements_Count);
